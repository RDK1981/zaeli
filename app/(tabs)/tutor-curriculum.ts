...
const MATHS_TOPICS: Record<string, string[]> = {
  ...
  'Year 2': ['Times tables', 'Sharing equally', 'Fractions', 'Zaeli picks'],
  'Year 3': ['Multiplication', 'Division', 'Fractions', 'Zaeli picks'],
  'Year 4': ['Long multiplication', 'Decimals', 'Fractions', 'Zaeli picks'],
  'Year 5': ['Percentages', 'Decimals', 'Fractions', 'Zaeli picks'],
  'Year 6': ['Fractions', 'Ratios', 'Order of operations', 'Zaeli picks'],
  'Year 7': ['Algebra', 'Integers', 'Simple interest', 'Zaeli picks'],
  'Year 8': ['Index laws', 'Pythagoras', 'Linear equations', 'Zaeli picks'],
  'Year 9': ['Quadratics', 'Trigonometry', 'Binomials', 'Zaeli picks'],
  'Year 10': ['Quadratic formula', 'Surds', 'Financial maths', 'Zaeli picks'],
  'Year 11': ['Calculus', 'Functions', 'Probability', 'Zaeli picks'],
  'Year 12': ['Integration', 'Statistics', 'Complex numbers', 'Zaeli picks'],
};

const ENGLISH_TOPICS: Record<string, string[]> = {
  'Foundation': ['Letter sounds', 'Sight words', 'Story retelling', 'Zaeli picks'],
  'Year 1': ['Phonics', 'Sight words', 'Simple sentences', 'Zaeli picks'],
  'Year 2': ['Main idea', 'Predictions', 'Writing recounts', 'Zaeli picks'],
  'Year 3': ['Comprehension', 'Persuasive writing', 'Vocabulary', 'Zaeli picks'],
  'Year 4': ['Figurative language', 'Themes', 'Essay writing', 'Zaeli picks'],
  'Year 5': ['Author purpose', 'Persuasive essays', 'Bias', 'Zaeli picks'],
  'Year 6': ['Comparative analysis', 'Irony and satire', 'Analytical essays', 'Zaeli picks'],
  'Year 7': ['Literary devices', 'Persuasive writing', 'PEEL paragraphs', 'Zaeli picks'],
  'Year 8': ['Poetry analysis', 'Creative writing', 'Film analysis', 'Zaeli picks'],
...
const SCIENCE_TOPICS: Record<string, string[]> = {
  ...
  'Year 4': ['Ecosystems', 'Electricity', 'Water cycle', 'Zaeli picks'],
  'Year 5': ['Body systems', 'Forces', 'Solar system', 'Zaeli picks'],
  'Year 6': ['Classification', 'Chemical changes', 'Energy', 'Zaeli picks'],
  'Year 7': ['Cells', 'Periodic table', 'Plate tectonics', 'Zaeli picks'],
  'Year 8': ['Genetics', 'Chemical reactions', 'Waves', 'Zaeli picks'],
  'Year 9': ['Evolution', 'Acids and bases', 'Motion', 'Zaeli picks'],
  'Year 10': ['Mendelian genetics', 'Newton laws', 'Cosmology', 'Zaeli picks'],
};
...
const HASS_TOPICS: Record<string, string[]> = {
  ...
  'Year 2': ['Community changes', 'Maps', 'Money', 'Zaeli picks'],
  'Year 3': ['First Australians', 'Gold rush', 'Government', 'Zaeli picks'],
  'Year 4': ['Colonisation', 'Climate zones', 'Supply and demand', 'Zaeli picks'],
  'Year 5': ['Immigration', 'Environment', 'Democracy', 'Zaeli picks'],
  ...
  'Year 8': ['Medieval world', 'Water resources', 'Media and democracy', 'Zaeli picks'],
