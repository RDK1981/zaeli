  ...
  async function send(overrideText?: string) {
    ...
    try {
      ...
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body:JSON.stringify({ model:'claude-sonnet-5', max_tokens:600, system, tools:TOOLS, messages:apiMessages }),
      });
      ...
      logApiCall({ family_id:FAMILY_ID, feature:'todos_chat', model:'claude-sonnet-5', input_tokens:inTok, output_tokens:outTok, cost_usd:cost });
      ...
      if (toolUses.length > 0) {
        ...
        const followUp = await fetch('https://api.anthropic.com/v1/messages', {
          ...
          headers:{ 'Content-Type':'application/json', 'x-api-key':anthropicKey, 'anthropic-version':'2023-06-01' },
          body:JSON.stringify({
            model:'claude-sonnet-5', max_tokens:300, system, tools:TOOLS,
